...
int main(void)
{
    ...
    int32_t coef2 [6] = {512, 1024, 512, 512, -925, 547};
    int32_t coef3 [6] = {512, -1024, 512, 512, -924, 509};
    int32_t coef4 [6] = {512, -1024, 512, 512, -930, 509};
    int gain1100 = 4;
    int32_t coef1 [6] = {512, 1024, 512, 512, -956, 506};
