...
sos[0,1] = (sos[0,1]/sos[0,0])*2**9
sos[0,2] = (sos[0,2]/sos[0,0])*2**9
sos[0,0] = 1*2**9
sos[0,4] = sos[0,4]*2**9
sos[0,5] = sos[0,5]*2**9
sos[1] = sos[1]*2**9
sos[2] = sos[2]*2**9
sos[3] = sos[3]*2**9
plt.plot([800, 900], [0.9, 0.9], "r--")
plt.plot([800, 900], [0.1, 0.1], "r--")
...
plt.axis([800, 900, 0.01, 1.2])
plt.show()
print(a)
print(b)
print(sos)
print((2**9)**2)
print((2**9)*gain900**(1/4))
